 ...
 */
final class Version20241115110455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, author VARCHAR(255) NOT NULL, publication_year INT NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', genre VARCHAR(255) DEFAULT NULL, summary LONGTEXT NOT NULL, publisher VARCHAR(255) NOT NULL, language VARCHAR(255) NOT NULL, edition VARCHAR(255) DEFAULT NULL, cover_image VARCHAR(255) DEFAULT NULL, INDEX IDX_AC634F9912469DE2 (category_id), INDEX IDX_AC634F99A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
